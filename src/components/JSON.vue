...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :key="author.id" :style= "[author.name=='George Orwell' ? 'color: red' : 'color: default']">
      ...
      <ul>
        <li v-for="author in modernAuthors" :key="author.id" :style= "[author.name=='George Orwell' ? 'color: red' : 'color: default']"> 
          {{ author.name }} ({{ author.birthYear }})
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="openingHour in bookstores.openingHours" :key="openingHour">
          {{ openingHour }}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <p>Highlighting Specific Authors: George Orwell</p>
    </section>
  </div>
</template>
